...
(0, rclnodejs_1.init)().then(() => {
    ...
    (0, common_node_infra_1.subscribe)((0, common_node_infra_1.node)('odometry_subscriber_test_node'), 'nav_msgs/msg/Odometry', '/odom', mqtt);
});
//# sourceMappingURL=odometry.subscriber.test.node.js.map